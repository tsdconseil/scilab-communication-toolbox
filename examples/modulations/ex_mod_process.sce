...
cdir = get_absolute_file_path("ex_mod_process.sce");
xs2png(gcf(), cdir + '../../help/en_US/modulations/ex_mod_process.png');


//fcd = fcd_init(wf,fs,fsymb);
//[fcd,y] = fcd_process(fcd, x);
